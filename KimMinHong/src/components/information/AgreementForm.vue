        ...
        <v-container class="white" style="width: 1400px">
          <v-row justify="center">
            <v-col cols="auto" style="padding-bottom: 50px">
                ...
                <h1>약관 동의</h1>
제1조(목적)
이 약관은 (주)PYE 회사(전자상거래 사업자)가 운영하는 비타민샵 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」

제2조(정의)
① “몰”이란 (주)PYE 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
제25조(적립금)
① 적립금은 "몰"내에서 현금처럼 사용되는 전자화폐이며,상품 구매시에만 이용할 수 있습니다.
② 적립금은 회원에 한하여 제공되는 서비스이며, 비회원의 경우 제품 구매나 이벤트 시 적립금을 지급하지 않습니다.
③ 적립금은 타 결제수단(신용카드,모바일,현금)과 함께 사용될 수 있습니다.
④ "몰"은 각종 할인이벤트 또는 제휴이벤트 등의 특정기간에는 적립금 사용을 제한할 수 있습니다.
⑤ "적립금은" 상품 구매시, 이용후기 등록시 제공하는 서비스로 보다 활발한 사용촉진을 위해 발생 후 1년이상 사용되지 않은 적립금은 연 1회 일괄 소멸됩니다.
            </div>
        </v-col>
    </v-row>
  </v-container>
